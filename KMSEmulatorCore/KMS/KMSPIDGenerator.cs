...
namespace KMSEmulatorCore.KMS
{
    class KMSPIDGenerator
    {
        ...
        private const int PkeyConfigWindowsServer2008 = 0;
        private const int PkeyConfigWindowsServer2008R2 = 1;
        private const int PkeyConfigWindowsServer2012 = 2;
        private const int PkeyConfigWindowsServer2012R2 = 3;
        private const int PkeyConfigWindowsServer2016 = 4;
        private const int PkeyConfigOffice14 = 5;
        private const int PkeyConfigOffice15 = 6;
        private const int PkeyConfigOffice16 = 7;
        ...
        public string CreateKMSPID(KMSRequest request)
        {
            ...
            List<HostOS> hostOSList = new List<HostOS>
            {
                ...
                new HostOS { Type = 6401, OSBuild =  9600, MinimumDay =  27, MinimumYear = 2013}, // Windows Server 2012 R2 RTM: 01/27/2013 RTM GA
                new HostOS { Type = 3612, OSBuild = 14393, MinimumDay = 215, MinimumYear = 2016}  // Windows Server 2016 RTM:    08/02/2016 WZOR LEAK
            };
            ...
            List<PkeyConfig> pkeyConfigList = new List<PkeyConfig>
            {
                ...
                new PkeyConfig { GroupID = 206, PIDRangeMin = 471000000, PIDRangeMax = 530999999 }, // Windows Server 2016
